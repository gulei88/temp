 ...
 * @author  __USER__
 */
public class throw_course extends javax.swing.JDialog {
	...
	public throw_course(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
//		infomation();
	}
...
//		 }
	...
	public static void main(String args[]) {
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				throw_course dialog = new throw_course(new javax.swing.JFrame(), true);
