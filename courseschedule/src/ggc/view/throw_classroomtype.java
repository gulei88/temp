 ...
 * @author  __USER__
 */
public class throw_classroomtype extends javax.swing.JDialog {
	...
	public throw_classroomtype(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
//		infomation();
	}
...
//		 }
	...
	public static void main(String args[]) {
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				throw_classroomtype dialog = new throw_classroomtype(new javax.swing.JFrame(), true);
