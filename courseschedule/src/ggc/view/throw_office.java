 ...
 * @author  __USER__
 */
public class throw_office extends javax.swing.JDialog {
	...
	public throw_office(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
//		infomation();
	}
...
//		 }
	...
	public static void main(String args[]) {
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				throw_office dialog = new throw_office(new javax.swing.JFrame(), true);
