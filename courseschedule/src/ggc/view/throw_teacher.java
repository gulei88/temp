 ...
 * @author  __USER__
 */
public class throw_teacher extends javax.swing.JDialog {
	...
	public throw_teacher(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
//		infomation();
	}
...
//		 }
	...
	public static void main(String args[]) {
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				throw_teacher dialog = new throw_teacher(new javax.swing.JFrame(), true);
