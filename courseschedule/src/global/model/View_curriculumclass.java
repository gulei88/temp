 ...
 * 
 */
public class View_curriculumclass {
	private int cc_id;
	private int tt_id;
	...
	public View_curriculumclass(int cc_id, int tt_id, String cou_id,
			String cou_name, String cla_name, int lessons, int week,
			String inweeks, String t_id, String t_name, String t_tel,
			int sy_id, String sy_name, int b_id, String b_name,
			String b_address, int cr_id, String cr_name) {
		super();
		this.cc_id = cc_id;
		this.tt_id = tt_id;
		this.cou_id = cou_id;
